...
public class GunBullet extends MovableBullet {
	...
	public GunBullet(Point coordInTiles, ShootableObject target, Player owner,
		...
		super(new Point ((int)coordInTiles.getX() + 1, (int)coordInTiles.getY() + 1), target, owner, force, map);
	...
	public GunBullet(Point coordInTiles, Player owner, int force, int range) {
		super(new Point ((int)coordInTiles.getX() + 1, (int)coordInTiles.getY() + 1), owner, force);
		this.initialPoint = this.coordInTiles;
		this.range = range;
		this.finalCoordInTiles = new Point ((int)coordInTiles.getX () + range, (int)coordInTiles.getY() + range);
	}
